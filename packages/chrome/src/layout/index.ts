...
export class BrowserMock extends LitElement {
    ...
    render() {
        return [
            html`
                <nav>
                    <div class="box l">
                        ${this.renderTabLink(VIEW_PROJECTS)}
                    </div>
                    <div class="box r">
                        ${this.renderTabLink(VIEW_NEW, html`
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px">
                                <path d="M440-120v-320H120v-80h320v-320h80v320h320v80H520v320h-80Z"/>
                            </svg>`)}
                        ${this.renderTabLink(VIEW_CONFIG, html`
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px">
                ...
                <div class="cnt">
                    ${this.currentView === VIEW_PROJECTS ? html`<wf-view-projects
    ...
    renderTabLink = (view: string, cnt: string | TemplateResult = i18n.view[view]) => html`
    ...
    handleMainNavClick = async (e: MouseEvent, view: string) => {
        e.preventDefault();
        this.setView(view);
    }
